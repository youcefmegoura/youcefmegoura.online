...
export function Page({data}: { data: SiteData }) {
    ...
    useEffect(() => {
        ...
        console.log(
            `%cThis portfolio, available at ${data.meta.site_url}, was built with Next.js, Tailwind CSS, and Framer Motion. Feel free to explore 🚀`,
        ...
        console.log(
            '%c  LinkedIn → ' + data.meta.social.linkedin + '\n  GitHub   → ' + data.meta.social.github + '\n  Email    → ' + data.meta.social.email,
            'color:#a1a1aa;font-size:12px;line-height:1.8;',
        );
    }, [data.meta.site_url, data.meta.social.email, data.meta.social.github, data.meta.social.linkedin]);
